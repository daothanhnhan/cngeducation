<?php
    if (isset($_GET['search']) && $_GET['search'] != '') {
        $rows = $action->getSearchAdmin('home',array('page_name','page_des','page_content','page_sub_info1','page_sub_info2','page_sub_info3','page_sub_info4','page_sub_info5'), $_GET['search'],$trang,20);
    }else{
	   $rows = $action->getList('home','','','page_id','desc',$trang,20,'module-home');
    }
...
?>
	<div class="boxPageContent">
    	<div class="searchBox">
    		<form action="">
    			<input type="hidden" name="page" value="module-home">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php 
                    ...
                    ?>
                        <tr>
                            <td><a href="index.php?page=sua-module-home&id=<?= $row['page_id'];?>" title="<?= $row['page_name'];?>"><?= $row['page_name'];?></a></td>
                            <td>
