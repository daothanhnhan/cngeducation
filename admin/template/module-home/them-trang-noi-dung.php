<form action="" method="post" accept-charset="utf-8" id="addHome">

    <input type="hidden" name="action" value="addHome">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Phụ</p>
            <textarea class="longtxtNCP2" rows="3" name="page_sub_info1"><?= $row['page_des'];?></textarea>
