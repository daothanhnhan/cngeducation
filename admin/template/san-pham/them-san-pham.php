        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                <div class="subColContent">
                    ...
                    <input type="date" class="txtNCP1" value="<?php echo date('Y-m-d');?>" name="product_created_date"/>
                ...
                <div class="subColContent">
                    ...
                    <input type="date" class="txtNCP1" value="<?php echo date('Y-m-d');?>" name="date_end"/>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_favorite">sự kiện nổi bật
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_new" <?= $rowPro['product_new'] == 1 ? 'checked' : '' ?>>sự kiện mới
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_hot" <?= $rowPro['product_hot'] == 1 ? 'product_hot' : '' ?>>sự kiện bán chạy
