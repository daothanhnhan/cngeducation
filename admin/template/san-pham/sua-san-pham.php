...
<script>
    ...
    function deleteColor(val){
        ...
        if (confirm('Xóa màu sự kiện, sẽ xóa tất cả kích cỡ của màu này')) {
                                    ...
                                    <div role="tabpanel" class="tab-pane <?= $key == 0 ? 'active' : ''?>" id="<?= $lang['languages_code']?>">
                                        ...
                                        <div class="rowNCP">
                                            ...
                                            <div class="subColContent">
                                                ...
                                                <p class="titleRightNCP">Mã sự kiện</p>
...
<form action="" method="post" enctype="multipart/form-data" id="updateProduct">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Thông tin sự kiện</span>

            <p class="subLeftNCP">Cung cấp thông tin về tên, mô tả loại sự kiện và nhà sản xuất để phân loại sự kiện</p>   

            <p class="titleRightNCP">Chọn ảnh đại diện cho sự kiện</p>
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Tên sự kiện</p>
           ...
           <!--  <p class="titleRightNCP">Danh mục</p>
            ...
            <a href="index.php?page=noi-su-kien&product_id=<?= $row['product_id'] ?>" title="" style="color: #fff;padding: 10px;border: 1px solid #000;margin-top: 10px;background: red;">Nơi tổ chức sự kiện</a>
    ...
    <div class="rowNodeContentPage hidden">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Ảnh phụ sự kiện</span>

            <p class="subLeftNCP">Thiết lập ảnh phụ cho sự kiện</p>

        </div>

        <div class="boxNodeContentPage">

            <h3>Ảnh phụ sự kiện</h3>
    ...
    <div class="rowNodeContentPage hidden">
        ...
        <div class="leftNCP">
            ...
            <p class="subLeftNCP">Bạn có thể cấu hình và quản lý kho cho từng loại của sự kiện này</p>
    ...
    <div class="rowNodeContentPage hidden">
        ...
        <div class="leftNCP">
            ...
            <p class="subLeftNCP">Bạn có thể cấu hình và quản lý thuộc tính cho từng loại của sự kiện này</p>
            ...
            <div class="rowNCP">
                ...
                <?php } ?>
                 ...
                 <div class="subColContent">
                    ...
                    <p class="titleRightNCP">sự kiện cùng loại khách màu</p>
    ...
    <div class="rowNodeContentPage">
        ...
        <!-- <div class="leftNCP">
            ...
            <span class="titLeftNCP">Ảnh sự kiện</span>

            <p class="subLeftNCP">Thiết lập ảnh sự kiện</p>
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="leftNCP">
            ...
            <span class="titLeftNCP">Quản lý sự kiện</span>

            <p class="subLeftNCP">Bạn có thể cấu hình và quản lý thông số của sự kiện này</p>

        </div>

        <div class="boxNodeContentPage">

            <div class="rowNCP" style="display: none;">
            ...
            <div class="rowNCP">
                <div class="subColContent">
                    ...
                    <p class="titleRightNCP">Ngày đăng</p>

                    <input type="date" class="txtNCP1" value="<?php echo date('Y-m-d', strtotime($row['product_created_date']));?>" name="product_created_date"/>

                </div> 

                <div class="subColContent">

                    <p class="titleRightNCP">Ngày cuối</p>

                    <input type="date" class="txtNCP1" value="<?php echo date('Y-m-d', strtotime($row['date_end']));?>" name="date_end"/>
        ...
        <div class="boxNodeContentPage">
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_favorite" <?= $row['product_favorite'] == 1 ? 'checked' : '' ?>>sự kiện nổi bật
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_new" <?= $row['product_new'] == 1 ? 'checked' : '' ?>>sự kiện mới
            ...
            <div>
                ...
                <label class="selectCate">
                    ...
                    <input type="checkbox" value="1" name="product_hot" <?= $row['product_hot'] == 1 ? 'checked' : '' ?>>sự kiện bán chạy
