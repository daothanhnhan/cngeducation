<?php 
	...
	function cam_nhan () {
		...
		if (isset($_POST['add_trademark'])) {
			...
			$sql = "INSERT INTO cam_nhan (name, title, note, image) VALUES ('$name', '$title', '$note', '$image')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một cảm nhận.\');window.location.href="index.php?page=cam-nhan"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <input type="text" class="txtNCP1" name="title" required/>
