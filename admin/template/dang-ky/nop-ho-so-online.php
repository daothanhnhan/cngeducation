<?php 
 ...
 //    }
	...
	// }
$rows_lien_he = $action->getList('ho_so_online','','','id','desc',$trang,20,'nop-ho-so-online');//var_dump($rows_lien_he);die();
?>
<div class="container-fluid">
  <h2>Bảng Nộp hồ sơ online.</h2>            
  <table class="table">
    <thead>
      <tr>
      	<th>Name</th>
    ...
    <?php foreach ($rows_lien_he['data'] as $v_row_lh) { ?>
      <tr>
        ...
        <td><?php echo $v_row_lh['nguyen_vong'];?></td>
        <td><?php echo $v_row_lh['note'];?></td>
        <td><a href="/images/passport/<?= $v_row_lh['passport'] ?>" target="_blank"><img src="/images/passport/<?= $v_row_lh['passport'] ?>" alt="" width="100"></a></td>
        <td><a href="/images/passport/<?= $v_row_lh['bang_diem'] ?>" target="_blank"><img src="/images/passport/<?= $v_row_lh['bang_diem'] ?>" alt="" width="100"></a></td>
        <td><a href="/images/passport/<?= $v_row_lh['chung_chi_en'] ?>" target="_blank"><img src="/images/passport/<?= $v_row_lh['chung_chi_en'] ?>" alt="" width="100"></a></td>
        <td><?php echo $v_row_lh['ngay'];?></td>
      </tr>
      <?php $i++; } ?>
    </tbody>
  </table>
