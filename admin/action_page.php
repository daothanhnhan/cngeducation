...
class action_page extends library{
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$product_created_date = isset($_POST['product_created_date']) ? $_POST['product_created_date'] : '0000-00-00';

			$date_end = isset($_POST['date_end']) ? $_POST['date_end'] : '0000-00-00';

			// $product_created_date .= ' 00:00:00';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiisssssssssssssssssisissssii');
   ...
   //          }
	...
	/*----------------- Trang nội dung -------------------*/
		...
		public function updatePage(){
	    	...
	    	//////////////////////
	    	$sql = "UPDATE page_languages SET friendly_url = '$friendly_url' WHERE page_id = $page_id";
	    	$result = mysqli_query($conn_vn, $sql);
	    	//////////////////////
	...
	/*---------------- Danh mục tin tức --------------------*/
		...
		public function updateNewsCat(){
	    	...
	    	///////////////////
	    	$sql = "UPDATE newscat_languages SET friendly_url = '$friendly_url' WHERE newscat_id = $newscat_id";
	    	$result = mysqli_query($conn_vn, $sql);
	    	///////////////////
	...
	/*------------------ Tin tức -------------------*/
		...
		public function updateNews(){
	    	...
	    	///////////////////
	    	$sql = "UPDATE news_languages SET friendly_url = '$friendly_url' WHERE news_id = $news_id";
	    	$result = mysqli_query($conn_vn, $sql);
	    	///////////////////
...
/*---------------- Danh mục dịch vụ --------------------*/
	...
	/*------------------ dịch vụ -------------------*/
		...
		public function updateService(){
	    	...
	    	///////////////////
	    	$sql = "UPDATE service_languages SET friendly_url = '$friendly_url' WHERE service_id = $service_id";
	    	$result = mysqli_query($conn_vn, $sql);
	    	///////////////////
		...
		public function addHome(){
	    	...
	    	$friendly_url = $this->GetFinalSlug($friendly_url, 'home', '');

	    	$insert = $this->Insert_1('home', 
	    	...
	    	if($insert != ''){
	    		...
	    		foreach ($languages as $key => $lang) {
	    			...
	    			$insert1 = $this->Insert_1('home_languages', 
	    		...
	    		echo json_encode(array('success'=>'Thêm mới thành công', 'url'=>'index.php?page=sua-module-home&id='.$insert));
		...
		public function updateHome(){
			...
			$page_sub_info6 = isset($_POST['page_sub_info6']) ? $_POST['page_sub_info6'] : '';

			$page_sub_info7 = isset($_POST['page_sub_info7']) ? $_POST['page_sub_info7'] : '';

			$page_sub_info8 = isset($_POST['page_sub_info8']) ? $_POST['page_sub_info8'] : '';
	    	...
	    	if (isset($_FILES['fileUpload6']) && $_FILES['fileUpload6']['name'] != "") {
	    		...
	    		$page_img_4 = $_POST['page_img_4'];

	    	}

	    	//////////////////////
	    	$sql = "UPDATE home_languages SET friendly_url = '$friendly_url' WHERE page_id = $page_id";
	    	$result = mysqli_query($conn_vn, $sql);
	    	//////////////////////
		...
		public function deleteHome(){
			...
			if($this->Delete_1('home','',array(&$page_id),array('page_id'),'i')){

				echo json_encode(array('success'=>'Xóa thành công','url'=>'index.php?page=module-home'));
		...
		public function updateLangHome () {
			$page_id = isset($_POST['page_id']) ? $_POST['page_id'] : '';
    		...
    		foreach ($lang as $key => $value) {
    			...
    			if(!$this->Update_1('home_languages',
    								 ...
    								 array(&$value['lang_page_name'], 
    								 	   ...
    								 	   &$value['lang_page_sub_info6'],

    								 	   &$value['lang_page_sub_info7'],

    								 	   &$value['lang_page_sub_info8'],
