<div class="fixedLeft">
    <div class="contentFL">
        <ul class="listMenuFL">
          ...
          <!--   <li><a href="index.php?page=danh-muc-san-pham" title=""
            ...
            <li><a href="index.php?page=san-pham" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'san-pham' || $_GET["page"] == 'them-san-pham' || $_GET["page"] == 'sua-san-pham') {
                       echo 'sltMenu';
                                                                               ...
                                                                               class="iconMenu"/>Danh sách sự kiện</a></li>
            ...
            <li><a href="index.php?page=slideshow" title=""
 ...
 -->
            ...
            <!-- tab module home -->
           <li><a href="index.php?page=module-home" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'module-home' || $_GET["page"] == 'sua-module-home' || $_GET["page"] == 'them-module-home') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Module home</a></li>

            <li><a href="index.php?page=dang-ky-tu-van" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đăng ký tư vấn</a>
            </li>

            <li><a href="index.php?page=nop-ho-so-online" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Nộp hồ sơ online</a>
            </li>
            ...
            <!-- <li><a href="index.php?page=ho-tro" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Hỗ trợ siêu nhanh</a>
            </li> -->
    ...
    <p class="titleFixedTop">
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                case "sua-module-home":
                    echo "Sửa Module Home";
                    break;

                case "them-module-home":
                    echo "Thêm Module Home";
                    break;
    ...
    <div class="rightFixedTop">
        ...
        if (isset($_GET["page"])) {
            switch ($_GET["page"]) {
                ...
                case "sua-module-home":
                    echo "<a class='btnTop btnAddTop' href='index.php?page=module-home'>Quay lại</a>";
                    echo "<a class='btnTop btnAddTop' href='index.php?page=them-module-home'>Thêm mới</a>";
                    break;

                case "module-home":
                    echo "<a href='index.php?page=them-module-home' class='btnTop btnAddTop'>Thêm Mới</a>";
                    break;
