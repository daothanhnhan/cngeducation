        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case "module-home":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-noi-dung.css' />";
                        include_once("template/module-home/trang-noi-dung.php");
                        break;

                    case "sua-module-home":
                        include_once("template/module-home/chi-tiet-trang-noi-dung.php");
                        break;

                    case "them-module-home":
                        include_once("template/module-home/them-trang-noi-dung.php");
                        break;
                    ...
                    ////////////// noi su kien ////////////
                    case "noi-su-kien":
                        include_once("template/noi-su-kien/noi-su-kien.php");
                        break;
                    case "them-noi-su-kien":
                        include_once("template/noi-su-kien/them-noi-su-kien.php");
                        break;
                    case "sua-noi-su-kien":
                        include_once("template/noi-su-kien/sua-noi-su-kien.php");
                        break;
                    case "xoa-noi-su-kien":
                        include_once("template/noi-su-kien/xoa-noi-su-kien.php");
                        break;
                    ///////////// dang ky //////////////////
                    case "ho-tro":
                        include_once("template/dang-ky/ho-tro.php");
                        break;
                    case "dang-ky-tu-van":
                        include_once("template/dang-ky/dang-ky-tu-van.php");
                        break;
                    case "nop-ho-so-online":
                        include_once("template/dang-ky/nop-ho-so-online.php");
                        break;
                    ///////////// Default /////////////////
                    default:
