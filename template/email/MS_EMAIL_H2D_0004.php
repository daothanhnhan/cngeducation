...
<div class="gb-form-lienhe">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label><?= $lang=='vn' ? 'Bảng điểm' : 'Transcript' ?></label>
            <input type="file" name="bang_diem" class="form-control">
        </div>
        <div class="form-group">
            <label><?= $lang=='vn' ? 'Chứng chỉ ngoại ngữ' : 'Language certificate' ?></label>
            <input type="file" name="chung_chi_en" class="form-control">
        </div>
