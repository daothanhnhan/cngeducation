...
<head>
    ...
    <meta property="og:image" content="http://<?= $_SERVER['SERVER_NAME'] ?>/images/<?= $rowConfig['web_logo'] ?>" alt="logo" />
...
<div class="gb-content">
    ...
    if (isset($_GET['page'])){
        ...
        switch ($urlAnalytic) {
            ...
            case 'su-kien':
                $title = ($lang=='vn') ? 'Sự kiện' : 'Event';
                include_once dirname(__FILE__) . DIR_THEMES . "su-kien.php";break;

            case 'lich-su-kien':
                $title = ($lang=='vn') ? 'Lịch sự kiện' : 'Event calendar';
                include_once dirname(__FILE__) . DIR_THEMES . "lich-su-kien.php";break;

            case 'nop-ho-so-online':
                $title = ($lang=='vn') ? 'Hồ sơ online' : 'Online profile';
                include_once dirname(__FILE__) . DIR_THEMES . "ho-so-online.php";break;
        }
    }
...
<a href="tel:<?=$rowConfig['content_home10']?>" class="suntory-alo-phone suntory-alo-green" id="suntory-alo-phoneIcon" style="left: 0px; bottom: 0px;" datasqstyle="{&quot;top&quot;:null}" datasquuid="4c643075-c7e6-4adf-8841-746771cfb831" datasqtop="640">
